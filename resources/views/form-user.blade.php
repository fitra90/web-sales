            ...
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="<?= isset($data) ? '/save-edit-user/'.$data->id : '/save-new-user'; ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="username" class="form-control" id="username" value="<?= isset($data) ? $data->username : ""; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Password</label>
                        <div class="col-md-6">
                            <input type="password" name="password" class="form-control" id="password" value="<?= isset($data) ? $data->password : ""; ?>">
                        </div>
                    </div>
                    <div class="form-group">
